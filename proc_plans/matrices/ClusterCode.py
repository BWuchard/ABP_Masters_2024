...
df = pd.read_excel('4marketcosinecolumn.xlsx')
print(df)
...
for cluster_num in range(1, n_clusters + 1):
    ...
    countries_in_cluster = df[df['Cluster'] == cluster_num]['Position'].tolist()
...
output_filename = '4marketcosinesimilaritycluster.xlsx'
